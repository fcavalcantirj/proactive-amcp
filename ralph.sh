...
PHASE RESTRICTION: ONLY work on tasks where phase=4. Phase 1, 2, and 3 are COMPLETE.
If all phase 4 tasks pass, STOP and report PHASE_4_COMPLETE.

1. Find the highest-priority requirement in specs/prd-v1.json where passes=false AND phase=4 and work ONLY on that.
